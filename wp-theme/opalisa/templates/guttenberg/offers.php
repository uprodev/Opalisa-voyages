        ...
        <div class="content">
            <div class="item">
                ...
                <div class="text">
                    ...
                    <ul>
                        <li><img src="<?= get_template_directory_uri();?>/img/icon-2-1.svg" alt="">Vacances d’été</li>
                        <li><img src="<?= get_template_directory_uri();?>/img/icon-2-2.svg" alt="">Classe économique</li>
                    </ul>
                    <div class="btn-wrap">
            ...
            <div class="item">
                <figure>
                    <p class="label">offre spéciale</p>
                    <a href="#">
                        <img src="<?= get_template_directory_uri();?>/img/img-1-2.jpg" alt="">
                    </a>
                </figure>
                <div class="text">
                    <h6><a href="#">Rio</a></h6>
                    <ul>
                        <li><img src="<?= get_template_directory_uri();?>/img/icon-2-1.svg" alt="">Vacances de la Toussaint</li>
                        <li><img src="<?= get_template_directory_uri();?>/img/icon-2-2.svg" alt="">Classe économique</li>
                    </ul>
                    <div class="btn-wrap">
            ...
            <div class="item">
                <figure>
                    <a href="#">
                        <img src="<?= get_template_directory_uri();?>/img/img-1-3.jpg" alt="">
                    </a>
                </figure>
                <div class="text">
                    <h6><a href="#">Porto</a></h6>
                    <ul>
                        <li><img src="<?= get_template_directory_uri();?>/img/icon-2-1.svg" alt="">Vacances de Pâcques</li>
                        <li><img src="<?= get_template_directory_uri();?>/img/icon-2-2.svg" alt="">Classe économique</li>
                    </ul>
                    <div class="btn-wrap">
            ...
            <div class="item">
                <figure>
                    <a href="#">
                        <img src="<?= get_template_directory_uri();?>/img/img-1-4.jpg" alt="">
                    </a>
                </figure>
                <div class="text">
                    <h6><a href="#">Le Caire</a></h6>
                    <ul>
                        <li><img src="<?= get_template_directory_uri();?>/img/icon-2-1.svg" alt="">Vacances d’hiver</li>
                        <li><img src="<?= get_template_directory_uri();?>/img/icon-2-2.svg" alt="">Classe économique</li>
                    </ul>
                    <div class="btn-wrap">
